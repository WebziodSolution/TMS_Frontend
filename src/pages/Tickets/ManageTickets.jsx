...
import { IconButton, Chip, Tooltip, tooltipClasses, Box } from '@mui/material';
...
const ManageTickets = ({ setAlert }) => {
    ...
    const fetchTickets = async () => {
        try {
            ...
            if (watch('type')) {
                filter.type = TICKET_TYPES?.find((item) => item?.value === watch('type'))?.label;
            }
    ...
    useEffect(() => {
        fetchTickets();
    }, [watch('filterType'), watch('startDueDate'), watch('endDueDate'), watch('search'), watch("type")]);
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-2">
                <div className="flex flex-wrap lg:flex-nowrap items-center gap-4 w-full">
                    <CustomInput
                        ...
                        sx={{ width: { xs: '100%', sm: 180, md: 220, lg: 250 }, minWidth: { lg: 150 } }}
                    />
                    <CustomSelect
                        name="type"
                        control={control}
                        ...
                        className="mb-0"
                        sx={{ width: { xs: '100%', sm: 110, md: 130, lg: 130 }, minWidth: { lg: 100 } }}
                    />
                    <CustomSelect
                        name="filterType"
                        control={control}
                    ...
                    <Box sx={{ width: { xs: '100%', sm: 130, md: 140, lg: 170 }, minWidth: { lg: 130 }, flexShrink: 1 }}>
                        <DatePickerComponent
                            control={control}
                            name="startDueDate"
                            label="Start Date"
                    ...
                    <Box sx={{ width: { xs: '100%', sm: 'auto' }, flexShrink: 0 }}>
                        <CustomButton
                            onClick={() => { setValue('startDueDate', null); setValue('endDueDate', null); }}
                            sx={{ width: { xs: '100%', sm: 'auto' }, height: '40px' }}
                        >
                            Clear
                        </CustomButton>
                    </Box>
            ...
            {view === 'table' ? (
                <div className="bg-white border border-[#DFE1E6] rounded-xl shadow-sm overflow-hidden">
                    {tickets.length === 0 ? (
                        ...
                        <div className="overflow-x-auto" style={{ maxHeight: 'calc(100vh - 210px)', overflowY: 'auto' }}>
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="flex items-center gap-2">
                                                    <span className="text-sm font-semibold text-[#172B4D] font-sans">
                                                        {ticket.title}
                                                    </span>
                                                    {ticket.type && (
                                                        <span style={{
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div>
                                                    <PermissionWrapper
                                                        ...
                                                        actionId={2}
                                                        component={
                                                            <IconButton onClick={(e) => { e.stopPropagation(); navigate(`/dashboard/manage-tickets/view/${ticket.id}`); }} size="small" sx={{ color: '#4C9AFF', '&:hover': { backgroundColor: '#E9F2FF' } }}>
